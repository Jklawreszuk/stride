...
namespace Stride.Core.Assets.Tests
{
    public partial class TestSerializing : TestBase
    {
        ...
        public void TestMyAssetObject()
        {
            ...
            string testGenerated1 = Path.GetFullPath(Path.Combine(DirectoryTestBase, @"TestSerializing/TestSerializing_TestMyAssetObject_Generated1.sdobj"));
            string testGenerated2 = Path.GetFullPath(Path.Combine(DirectoryTestBase, @"TestSerializing/TestSerializing_TestMyAssetObject_Generated2.sdobj"));
            string referenceFilePath = Path.GetFullPath(Path.Combine(DirectoryTestBase, @"TestSerializing/TestSerializing_TestMyAssetObject_Reference.sdobj"));
