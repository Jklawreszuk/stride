...
public class FileFontProvider : FontProviderBase
{
    ...
    public override FontFace GetFontFace()
    {
        ...
        var fontSimulations = Style switch
        {
            Stride.Graphics.Font.FontStyle.Regular => FontSimulations.None,
            Stride.Graphics.Font.FontStyle.Bold => FontSimulations.Bold,
            Stride.Graphics.Font.FontStyle.Italic => FontSimulations.Oblique,
    ...
    public override SixLabors.Fonts.Font GetFont()
    {
