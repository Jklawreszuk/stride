...
DLL_EXPORT_API REAL orient2dexact(REAL *pa, REAL *pb, REAL *pc)
{
...
DLL_EXPORT_API REAL orient2dslow(REAL *pa, REAL *pb, REAL *pc)
{
...
DLL_EXPORT_API REAL orient2dadapt(REAL *pa, REAL *pb, REAL *pc, REAL detsum)
{
	INEXACT REAL acx, acy, bcx, bcy;
...
DLL_EXPORT_API REAL orient3dexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
DLL_EXPORT_API REAL orient3dslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
DLL_EXPORT_API REAL orient3dadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
...
DLL_EXPORT_API REAL incircleexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
	INEXACT REAL axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
	INEXACT REAL bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
	REAL axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
...
DLL_EXPORT_API REAL incircleslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd)
{
...
DLL_EXPORT_API REAL incircleadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
	INEXACT REAL adx, bdx, cdx, ady, bdy, cdy;
	REAL det, errbound;
...
DLL_EXPORT_API REAL insphereexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
DLL_EXPORT_API REAL insphereslow(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
...
DLL_EXPORT_API REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent)
{
	INEXACT REAL aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
	REAL det, errbound;
...
DLL_EXPORT_API REAL insphere(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
