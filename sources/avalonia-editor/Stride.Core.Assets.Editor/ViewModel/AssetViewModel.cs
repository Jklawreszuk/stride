            ...
            : base(parameters.SafeArgument(nameof(parameters)).Directory.Session)
        {
            ...
            Dispatcher.InvokeAsync(() =>
            {
                assetCommands.Add(new MenuCommandInfo(ServiceProvider, createDerivedAssetCommand)
                {
                    ...
                    Icon = new Image { Source = new Bitmap(new Uri("/Stride.Core.Assets.Editor;component/Resources/Icons/copy_link-32.png", UriKind.RelativeOrAbsolute)) },
                });
                assetCommands.Add(new MenuCommandInfo(ServiceProvider, clearArchetypeCommand)
                {
                    DisplayName = "Clear archetype",
                    Icon = new Image { Source = new Bitmap(new Uri("/Stride.Core.Assets.Editor;component/Resources/Icons/delete_link-32.png", UriKind.RelativeOrAbsolute)) },
                });
            }).Forget();
