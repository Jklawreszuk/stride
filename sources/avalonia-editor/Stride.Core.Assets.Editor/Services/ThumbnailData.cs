...
namespace Stride.Core.Assets.Editor.Services
{
    public abstract class ThumbnailData : ViewModelBase
    {
        ...
        private static readonly Dictionary<ObjectId, Task<Bitmap>> ComputingThumbnails = [];
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract Bitmap BuildImageSource();
    ...
    public sealed class ResourceThumbnailData : ThumbnailData
    {
        ...
        /// <inheritdoc />
        protected override Bitmap BuildImageSource()
        {
            if (resourceKey == null)
                return null;
            try
            {
                var uri = new Uri(resourceKey.ToString());
    ...
    {
        private static readonly ObjectCache<ObjectId, Bitmap> Cache = new ObjectCache<ObjectId, Bitmap>(512);
        ...
        private static Bitmap BuildAsBitmapImage(ObjectId thumbnailId, Stream thumbnailStream)
        {
