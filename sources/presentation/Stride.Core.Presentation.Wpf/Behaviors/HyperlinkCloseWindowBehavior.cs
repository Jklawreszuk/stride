...
{
    /// <summary>
    /// A behavior that can be attached to a <see cref="HyperlinkButton"/> and will close the window it is contained in when clicked. Note that if a command is attached to the button, it will be executed after the window is closed.
    ...
    /// </summary>
    public class HyperlinkCloseWindowBehavior : CloseWindowBehavior<HyperlinkButton>
    {
        /// <inheritdoc/>
