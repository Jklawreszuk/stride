...
namespace Stride.Core.Presentation.Core
{
    ...
    public static class FocusManager
    {
        ...
        /// </summary>
        public static readonly AvaloniaProperty IsFocusedProperty = AvaloniaProperty.RegisterAttached("IsFocused", typeof(bool), typeof(FocusManager), new UIPropertyMetadata(BooleanBoxes.FalseBox, OnIsFocusedPropertyChanged));
        ...
        public static void SetIsFocused([NotNull] AvaloniaObject obj, bool value)
        {
        ...
        private static void OnIsFocusedPropertyChanged(AvaloniaObject obj, AvaloniaPropertyChangedEventArgs e)
        {
