...
namespace Stride.Core.Presentation.Controls
{
    public class Trimming
    {
        ...
        /// </summary>
        public static readonly AttachedProperty<TextTrimming> TextTrimmingProperty = AvaloniaProperty.RegisterAttached<Trimming, AvaloniaObject, TextTrimming>("TextTrimming", TextTrimming.None);

        /// <summary>
        /// Identifies the <see cref="TrimmingSource"/> dependency property.
        /// </summary>
        public static readonly AttachedProperty<TrimmingSource> TrimmingSourceProperty = AvaloniaProperty.RegisterAttached<Trimming, AvaloniaObject, TrimmingSource>("TrimmingSource", TrimmingSource.End);

        /// <summary>
        /// Identifies the <see cref="WordSeparators"/> dependency property.
        /// </summary>
        public static readonly AttachedProperty<string> WordSeparatorsProperty = AvaloniaProperty.RegisterAttached<Trimming, AvaloniaObject, string>("WordSeparators", " \t");
        ...
        public static string ProcessTrimming([NotNull] Control control, string text, TextTrimming trimming, TrimmingSource source, string wordSeparators, double availableWidth)
        {
            ...
            var fontStretch = control.GetValue(TextBlock.FontStretchProperty);
